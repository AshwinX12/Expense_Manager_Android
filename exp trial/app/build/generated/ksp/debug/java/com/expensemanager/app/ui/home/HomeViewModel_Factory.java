...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel get() {
    return newInstance(transactionRepositoryProvider.get(), accountRepositoryProvider.get(), budgetRepositoryProvider.get(), categoryRepositoryProvider.get(), quickAddShortcutDaoProvider.get(), recurringTransactionRepositoryProvider.get());
  }
  ...
  public static HomeViewModel_Factory create(
      ...
      Provider<QuickAddShortcutDao> quickAddShortcutDaoProvider,
      Provider<RecurringTransactionRepository> recurringTransactionRepositoryProvider) {
    return new HomeViewModel_Factory(transactionRepositoryProvider, accountRepositoryProvider, budgetRepositoryProvider, categoryRepositoryProvider, quickAddShortcutDaoProvider, recurringTransactionRepositoryProvider);
  }
  ...
  public static HomeViewModel newInstance(TransactionRepository transactionRepository,
    ...
    return new HomeViewModel(transactionRepository, accountRepository, budgetRepository, categoryRepository, quickAddShortcutDao, recurringTransactionRepository);
  }
}
