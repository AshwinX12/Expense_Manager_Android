    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new HomeViewModel(singletonCImpl.provideTransactionRepositoryProvider.get(), singletonCImpl.provideAccountRepositoryProvider.get(), singletonCImpl.provideBudgetRepositoryProvider.get(), singletonCImpl.provideCategoryRepositoryProvider.get(), singletonCImpl.quickAddShortcutDao());
          ...
          return (T) new ScheduledViewModel(singletonCImpl.provideRecurringTransactionRepositoryProvider.get(), singletonCImpl.provideCategoryRepositoryProvider.get());
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) RepositoryModule_ProvideRecurringTransactionRepositoryFactory.provideRecurringTransactionRepository(singletonCImpl.recurringRuleDao(), singletonCImpl.transactionDao());
